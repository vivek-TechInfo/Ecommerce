...
const AdminEditProduct = ({ onClose,productData,getAllProduct }) => {
  ...
  const handleSubmit = async (e)=>{
    ...
    const responseData =  await fetch(summeryApi.updateProduct.url,{
  ...
  return (
    <div className="fixed w-full bg-blue-200 bg-opacity-35 h-full top-0 bottom-0 left-0 right-0 flex justify-center items-center">
      <div className="bg-white p-4 rounded w-full max-w-xl h-full max-h-[80%] overflow-hidden ">
        <div className="flex justify-between items-center">
          ...
          <div className="cursor-pointer hover:text-red-500 font-bold text-lg" onClick={onClose}>
            <RxCross2  />
          </div>
        </div>
